...
# from products.models import Product, ColorCatalogue

# class ServiceOrder(BaseModel):
#     renter = models.ForeignKey(Person, on_delete=models.CASCADE, related_name='service_orders')
...
# #     service_order = models.ForeignKey(ServiceOrder, related_name='items', on_delete=models.CASCADE)
