...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "roupadegala.pagination.StandardResultsSetPagination",
    "PAGE_SIZE": 20,
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(
        days=7
    ),  # Uma semana pra não deslogar no bagulho
    "REFRESH_TOKEN_LIFETIME": timedelta(days=30),  # 30 dias pro refresh
